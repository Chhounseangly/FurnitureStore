...
class AuthViewModel : BaseViewModel() {
    ...
    private val _userData = MutableLiveData<ApiData<ResProfile>>()
    ...
    val userData: LiveData<ApiData<ResProfile>> get() = _userData
    ...
    private fun loginService(email: String, password: String) {
        ...
        performApiCall(
            ...
            failureBlock = { err ->
                Log.e("AuthViewModel", "Login Fail: $err")
    ...
    private fun signUpService(
        ...
        performApiCall(
            ...
            failureBlock = { err ->
                Log.e("AuthViewModel", "Signup Fail: $err")
                ApiData(Status.Failed, null)
            }
        )
    }
    ...
    private fun verifyEmailService(email: String, code: String) {
        performApiCall(
            ...
            failureBlock = { err ->
                Log.e("AuthViewModel", "Verify Fail: $err")
                ApiData(Status.Failed, null)
            }
        )
    }
